...
internal class GetStoriesRequestExecutor(private val storyChaptersExecutor: GetChaptersRequestExecutor) {
        ...
        return try {
            ...
            val groupedStoriesLanguages = hashMapOf<Int, Lang?>().also { map ->
                storyRegistersWithStoryInfo.forEach { storyRow ->
                    ...
                    val storyLanguage = storiesLanguages.firstOrNull { lang -> lang.id == storyLanguageID }
            ...
            val storiesTags = selectTags(storiesEntityIDs, filter.environmentLangID)
