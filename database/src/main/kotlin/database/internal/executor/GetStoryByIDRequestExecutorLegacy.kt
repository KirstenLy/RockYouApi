...
internal class GetStoryByIDRequestExecutorLegacy(private val storyChaptersRequestExecutor: GetChaptersRequestExecutor) {

    suspend fun execute(storyRegisterID: Int): SimpleOptionalDataResult<Story> {
