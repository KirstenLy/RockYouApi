...
@Deprecated("В пользу TestDBBuilder")
...
internal class TestDBBuilderLegacy : TestDatabaseBuilder {
    ...
    override fun setStoriesNodes(nodes: List<Pair<Int, List<TestStoryNode>>>) = Unit
