...
internal suspend fun ApplicationCall.respondAsStringArgMustBeNotEmpty(argName: String) {
    respond(HttpStatusCode.BadRequest, "\"$argName\" must be filled")
}
...
internal suspend fun ApplicationCall.respondAsTokenExpired() {
    respond(HttpStatusCode.Unauthorized, "Token expired")
}